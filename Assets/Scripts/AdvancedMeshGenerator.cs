...
public class AdvancedMeshGenerator : MonoBehaviour
{
    private void OnEnable()
    {
        ...
        normals[0] = normals[1] = normals[2] = normals[3] = back(); //back is float3, vector3.back is vector3?
        ...
        tangents[0] = tangents[1] = tangents[2] = tangents[3] = half4(h1, h0, h0, h1);
